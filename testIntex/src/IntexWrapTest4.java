...
//			String accessCode = "bje388t5op3rci69p";
			...
			String dealName = "ctas14c1";
			String[] trancheNames = {"'M1'","'M2'","'AH'","'BH'","'COLLAT'" };
			...
			argOptions.add("CDI_PATH", IntexWrapTest4.CDI_PATH());
			argOptions.add("CDU_LOOKBACK_LIMIT_MODE", "NONE");
			argOptions.add("CDU_PATH", IntexWrapTest4.CDU_PATH());
...
//			}
			...
			argDeal.add("SETTLE_YYYYMMDD", "20141101");
